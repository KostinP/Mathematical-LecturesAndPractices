...
\begin{lect}{2019-11-12}
    ...
    \begin{Proof}
        ...
        \[\mathcal{\hat{V}} \text{ - линейнвя оболочка первых } r + 1 \text{ столбцов } V
        \qq(\text{ в } \R^n)\]
    ...
    \begin{Proof}
        ...
        (\overline{y} - b)}^2 = \frac{1}{m} \sum \Abs{y_1 - \overline{y}}^2 
        + \Abs{\overline{y} - b}^2 + \]
        \[+ \frac{2}{m}\sum_{i = 1}^m (y_1 - \overline{y}, \overline{y} - b)  =\]

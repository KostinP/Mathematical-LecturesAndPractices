...
\begin{lect} {2019-09-04}
	...
	\begin{Example}
		...
		\begin{figure}[H] %он не хотел вставлять сюда картинку, но я его заставил аргументом H
		    \center{\includegraphics[scale=0.3]{pics/1_1}}
		\end{figure}
		...
		\begin{figure}[h]
			\center{\includegraphics[scale=0.3]{pics/1_2}}
		\end{figure}
	...
	\subsection*{Топология $\R^n$, $d(x,y)=\sqrt{\sum_j^n|x_j-y_j|^2}$} %чтобы соответствовать твоему стилю пришлось продублировать
	\addcontentsline{toc}{subsection}{Топология $\R^n$, $d(x,y)=\sqrt{\sum_j^n|x_j-y_j|^2}$}
	...
	\addcontentsline{toc}{subsection}{Топологические св-ва}
	\begin{theorem}[св-ва]
			\begin{enumerate}
	...
	\begin{Proof}
		...
		\[\Cl X = (\ext X)^c = X^{cc} = X\]
	\end{Proof}
	\addcontentsline{toc}{subsection}{Ограниченность}
	\begin{definition}
		Ограниченность:
	...
	\addcontentsline{toc}{subsection}{Принцип выбора Больцано-Вейерштрасса}
	...
	\begin{examples}
		\begin{enumerate}
			...
			\begin{figure}[h]
			    \center{\includegraphics[scale=0.5]{pics/1_3}}
			\end{figure}

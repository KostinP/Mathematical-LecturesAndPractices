...
\begin{lect} {2019-09-25}
		\hsubsubsection{2.9.4}{Теорема о непр. диф. в точке}
		U - откр (всегда)
    ...
    \end{Example}
		...
		\hsubsubsection{2.10.1}{Теорема о замене порядка диф-ия в ч.п.}
    ...
    \begin{Definition}
		...
		\hsubsubsection{2.10.2}{Формула Тейлора}
		...
		\hsubsubsection{2.10.3}{Оценка остаточного члена в форме Лагранжа}

...
\begin{lect} {2019-09-18}
		...
		\hsubsubsection{2.8.1}{Дифференцирование композиции}
		...
		\hsubsubsection{2.8.2}{Частные производные композиции (в усл. теоремы)}
		\begin{Theorem}
		...
		\hsubsubsection{2.8.3}{Геометрические св-ва градиента}
		...
		\hsubsubsection{2.9.1}{Лемма о среднем}
		...
		\hsubsubsection{2.9.2}{Теорема о непр. диф. отображении в точке}
		...
		\hsubsubsection{2.9.3}{Непрерывно дифференцируемые отображения}

...
\begin{lect}{2019-12-04}
    ...
    \begin{Definition}
        ...
        %рисунок1
        \begin{figure}[H]
            \includegraphics[width=3cm]{pics/13_1.png}
            \centering
        \end{figure}
    ...
    \begin{Example}[3 сущ. ос-ть]\
        %рисунок2
        \begin{figure}[H]
            \includegraphics[width=3cm]{pics/13_2.png}
            \centering
        \end{figure}
    ...
    \begin{Definition}
        ...
        %рисунок3
        \begin{figure}[H]
            \includegraphics[width=4cm]{pics/13_3.png}
            \centering
        \end{figure}
    \end{Definition}
    ...
    \begin{Theorem}[Коши о вычетах]
        ...
        %рисунок4
        \begin{figure}[H]
            \includegraphics[width=4.5cm]{pics/13_4.png}
            \centering
        \end{figure}
    ...
    \begin{Proof}\
        %рисунок5
        \begin{figure}[H]
            \includegraphics[width=4cm]{pics/13_5.png}
            \centering
        \end{figure}
        ...
        %рисунок6
        \begin{figure}[H]
            \includegraphics[width=4.5cm]{pics/13_6.png}
            \centering
        \end{figure}
    ...
    \begin{Proof}
        %рисунок10(он 7)
        \begin{figure}[H]
            \includegraphics[width=3.5cm]{pics/13_7.png}
            \centering
        \end{figure}
        ...
        \begin{figure}[H]
            \includegraphics[width=4cm]{pics/13_8.png}
            \centering
        \end{figure}
    ...
    \begin{Proof}
        ...
        %рисунок12
        \begin{figure}[H]
            \includegraphics[width=5cm]{pics/13_10.png}
            \centering
        \end{figure}

...
\begin{lect}{2019-10-30}
    ...
    \begin{Definition}[обратное отображение и якобиан]
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=3cm]{10_1}
        \end{figure}
    ...
    \begin{Theorem}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=7cm]{10_2}
        \end{figure}
        \[z_1 \in U\]
        \[\omega_1 = f(z_1)\]
        \[z \in U \q \omega = f(z)\]
    ...
    \begin{Definition}\
        ...
        \end{figure}
        \[\gamma(t) = x(t) + iy(t) \qq 0 \leq t \leq 1 \qq \gamma \text{ - гладкая %шладкая
                кривая}\]
        \[\gamma'(t) = x'(t) + iy'(t)\]
    ...
    \begin{Consequence}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=7cm]{10_5}
        \end{figure}
    ...
    \begin{Lemma} [Гурса (т. Коши для $\bigtriangleup$)]
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=5cm]{10_8}
        \end{figure}
    ...
    \begin{Proof}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=3cm]{10_9}
        \end{figure}

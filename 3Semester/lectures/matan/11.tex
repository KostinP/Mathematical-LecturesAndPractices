...
\begin{document}
    ...
    \begin{Theorem}[т. Коши]
        ...
        %рисунок11_4 область с дыркой 10_5
        \[f \text{ - диф-ма } \forall z \in \Omega \setminus \{p\}\]
        \[f \in C(\Omega)\]
    ...
    \begin{Example}
        ...
        %рисунок11_6 гамма и область (можно забить)
    \end{Example}
    ...
    \begin{proof}
        ...
        %рисунок11_8 область L в области омега и L,10_9 которую подробили на куски
    ...
    \begin{Proof}
        ...
        %рисунок11_14 кружок в области L, которая в омега

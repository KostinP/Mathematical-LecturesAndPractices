...
\begin{document}
    ...
    \begin{Examples}
        ...
        \[\text{По т. о выч. } \int_{\Gamma_A} \frac{z}{z^2 + \E^2}e^{iz}dz =
            2\pi i \res_{\Ei} \frac{z}{z^2 + \E^2} e^{iz} =\]
        ...
        \[\int_{-\infty}^{+\infty} \frac{ze^{iz}dz }{z^2 + \E^2} =
            [z = x + i\cdot 0] = \int_{-\infty}^{+\infty} \frac{x(\cos x + i\sin x)}{x^2 + \E^2}dx =  \]
        \[ = \pi i e^{-\E} \]
    ...
    \begin{Proof}
        ...
        \[(\Im \varphi)'_y = -u''_{yy} \us{\Delta u = 0}{=}  u''_{xx} \]
        \[(\Im \varphi)'_x = -u''_{yx} \]
        \[(\Re \varphi)'_y = u''_{xy} \]

...
\begin{document}
    ...
    \begin{Remark}
        ...
        \end{cases}\]
        %пример рисунка. геод. линии с плоскости отправляем на цилиндр
    \end{Remark}
    ...
    \begin{sol}
        ...
        %Что происходит? У нас есть сфера с двумя произвольными точками a,b. Хотим найти кривую на сфере L, которая будет минимизировать расстояние
        %рисунок существует биекция между кривыми

...
\begin{question} {26. Алгебраически замкнутые поля. Эквивалентные переформулировки. \\Алегбраическая замкнутость поля
    ...
    \begin{definition} 
        Если для $K\text{и } K[x]$ выполнено любое из равносильных усл., то $K$ назыв. алгебр. замкн.
    \end{definition}
...
\begin{question} {27. Неприводимые многочлены над полем вещественных чисел. Теорема о разложении многочлена
